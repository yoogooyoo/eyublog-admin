  ...
  render() {
    return (
      <div className={this.state.collapsed ? 'nav-side fold' : 'nav-side unfold'}>
        ...
        >
          <SubMenu key="sub1"
                   title={ <span> <Icon type="file-text" /><span>文章管理</span></span>}
          >
          ...
          <SubMenu key="sub2"
                   title={ <span> <Icon type="inbox" /><span>收藏管理</span></span>}
          >
            <Item key="4"><Link to="/gather"><Icon type="caret-right" />收藏列表<Icon type="right" /></Link></Item>
            <Item key="5"><Link to="/new-gather"><Icon type="caret-right" />添加收藏<Icon type="right" /></Link></Item>
          </SubMenu>
          <SubMenu key="sub3"
                   title={ <span> <Icon type="share-alt" /><span>说说管理</span></span>}
          >
            <Item key="6"><Link to="/gossip"><Icon type="caret-right" />说说列表<Icon type="right" /></Link></Item>
            <Item key="7"><Link to="/new-gossip"><Icon type="caret-right" />添加说说<Icon type="right" /></Link></Item>
          </SubMenu>
        </Menu>
      </div>
    )
